            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="p-5">
                        ...
                        <form:form method="post" modelAttribute="users" class="user">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <form:input path="name" class="form-control form-control-user" id="exampleFirstName"
                                                placeholder="Imię"/>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <form:input path="email" class="form-control form-control-user" id="exampleInputEmail"
                                            placeholder="Email"/>
                        ...
                        <div class="text-center">
                            <a class="small" href="/">Masz już konto? Zaloguj się!</a>
                        </div>
                    </div>
                </div>
            </div>
